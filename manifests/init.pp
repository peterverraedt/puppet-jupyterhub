...
class jupyterhub (
  ...
  Optional[Boolean] $cleanup_proxy,
  Optional[Boolean] $cleanup_servers,
  Optional[Boolean] $custom_packages_enable,
  Optional[Boolean] $debug_enable,
  Optional[Boolean] $epel_enable,
  Optional[Boolean] $cfhproxy_should_start,
  Optional[Boolean] $kernelmanager_autorestart,
  Optional[Boolean] $ldap_enable,
  ...
  Optional[Integer] $kernelrestarter_restart_limit,
  ...
  Optional[Stdlib::Absolutepath] $spawner_notebook_dir,
  ...
  Optional[String] $cfhproxy_auth_token,
  ...
  Optional[String] $pip_version_batchspawner,
  Optional[String] $pip_version_jupyter,
  Optional[String] $pip_version_jupyterhub,
  Optional[String] $pip_version_sudospawner,
  Optional[String] $pip_version_systemdspawner,
  Optional[String] $pip_version_wrapspawner,
  Optional[String] $pip_version_oauthenticator,
  Optional[String] $pip_version_jupyterhub_ldapauthenticator,
  Optional[String] $pip_version_requests_oauthlib,
  Optional[String] $spawner_cmd,
  Optional[String] $spawner_default_url,
